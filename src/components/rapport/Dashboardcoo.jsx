...
export default function Dashboard({ dates, refresh }) {
    ...
    const fetchMontantTotalCredits = useCallback(async () => {
        try {
            ...
            setinteretTotalCreditsAccorde(Number(res.result?.interetCreditAccorde))
            ...
            setIntérêts(Number(res.result?.InteretTot))
            ...
            <div className="layout-content">
                <div className="grid">
                    ...
                    <div className="d-flex flex-wrap gap-3 justify-content-center w-100">
                        {/* Bloc Crédits accordés */}

                        <div className="cursor-pointer rounded border dashboad-main_counter"
                            style={{
                                height: 150,
                                width: "24%",
                                background: "linear-gradient(to bottom, #FF990A, #CE3A04)",
                            }}

                            onClick={(e) => {
                                e.preventDefault(); e.stopPropagation(); setVisible(true);
                            }}>

                            <div className="d-flex flex-column justify-content-center mt-3 px-2">
                                <h5 className="text-muted dashboard-title text-white">Crédits accordés</h5>
                                {/* <img src="/images/nodebu.jpg"  style={{ width: 30, height: 20,display:"flex" }} /> */}
                                ...
                                <h4 className="dashboard-title">{MontantTotalCreditsAccordes?.toLocaleString('fr') ?? 0} Fbu</h4>
                                <div className="d-flex mt-2" style={{ fontSize: 14 }}>
                                    <div className="cursor-pointer z-2" onClick={(e) => { e.preventDefault(); e.stopPropagation(); setVisibleClient(true); }}>
                                        Capital : {CapitalCreditAccordeTotal ?? 0}
                                    </div>
                                    <span className="mx-1">|</span>
                                    <div className="cursor-pointer z-2" onClick={(e) => { e.preventDefault(); e.stopPropagation(); setVisiblePatient(true); }}>
                                        Intérêt : {interetTotalCreditsAccorde ?? 0}
                                    </div>
                                </div>
                            </div>
                        ...
                        {/* Bloc Montant remboursé */}
                        <div className="cursor-pointer rounded border dashboad-main_counter"
                            style={{
                                height: 150,
                                width: "24%",
                                background: "linear-gradient(to bottom, #669934, #1CB808)",
                            }}
                            onClick={(e) => {
                                e.preventDefault(); e.stopPropagation(); setVisiblepayeTotal(true);
                            }}>
                            <div className="d-flex flex-column justify-content-center mt-3 px-2">
                                <h5 className="text-muted dashboard-title text-white">Montant Remboursé</h5>
                                <div className="d-flex align-items-center mt-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="40" viewBox="0 0 512 512"><path fill="white" d="M298.9 24.31c-14.9.3-25.6 3.2-32.7 8.4l-97.3 52.1l-54.1 73.59c-11.4 17.6-3.3 51.6 32.3 29.8l39-51.4c49.5-42.69 150.5-23.1 102.6 62.6c-23.5 49.6-12.5 73.8 17.8 84l13.8-46.4c23.9-53.8 68.5-63.5 66.7-106.9l107.2 7.7l-1-112.09zM244.8 127.7c-17.4-.3-34.5 6.9-46.9 17.3l-39.1 51.4c10.7 8.5 21.5 3.9 32.2-6.4c12.6 6.4 22.4-3.5 30.4-23.3c3.3-13.5 8.2-23 23.4-39m-79.6 96c-.4 0-.9 0-1.3.1c-3.3.7-7.2 4.2-9.8 12.2c-2.7 8-3.3 19.4-.9 31.6c2.4 12.1 7.4 22.4 13 28.8c5.4 6.3 10.4 8.1 13.7 7.4c3.4-.6 7.2-4.2 9.8-12.1c2.7-8 3.4-19.5 1-31.6c-2.5-12.2-7.5-22.5-13-28.8c-4.8-5.6-9.2-7.6-12.5-7.6m82.6 106.8c-7.9.1-17.8 2.6-27.5 7.3c-11.1 5.5-19.8 13.1-24.5 20.1c-4.7 6.9-5.1 12.1-3.6 15.2c1.5 3 5.9 5.9 14.3 6.3c8.4.5 19.7-1.8 30.8-7.3s19.8-13 24.5-20c4.7-6.9 5.1-12.2 3.6-15.2c-1.5-3.1-5.9-5.9-14.3-6.3c-1.1-.1-2.1-.1-3.3-.1m-97.6 95.6c-4.7.1-9 .8-12.8 1.9c-8.5 2.5-13.4 7-15 12.3c-1.7 5.4 0 11.8 5.7 18.7c5.8 6.8 15.5 13.3 27.5 16.9c11.9 3.6 23.5 3.5 32.1.9c8.6-2.5 13.5-7 15.1-12.3c1.6-5.4 0-11.8-5.8-18.7c-5.7-6.8-15.4-13.3-27.4-16.9c-6.8-2-13.4-2.9-19.4-2.8" /></svg>
                                    {/* <img src="/images/nodebu.jpg"  style={{ width: 50, height: 30 }} /> */}
                                    {/* <svg xmlns="http://www.w3.org/2000/svg" width="50" height="40" viewBox="0 0 26 26"><path fill="white" d="M12.875 2a1 1 0 0 0-.594.313L5.687 9H1c-.6 0-1 .4-1 1v2c0 .6.4 1 1 1h.094l2.718 9.313c.1.4.5.687 1 .687h16.5c.4 0 .8-.288 1-.688L25 13c.6 0 1-.4 1-1v-2c0-.6-.4-1-1-1h-4.594L13.72 2.281A1 1 0 0 0 12.875 2M13 4.438L17.594 9H8.5zm4.563 7.343c.2 0 .38.069.53.219l.72.688c.3.3.3.824 0 1.124l-6 6c-.3.3-.825.3-1.126 0l-3.374-3.406c-.3-.3-.3-.793 0-1.093l.687-.72c.3-.3.794-.3 1.094 0l2.219 2.22L17 12a.8.8 0 0 1 .563-.219"/></svg> */}
                                    <h4 className="dashboard-title ml-2">{MontantTatalCreditsRembourses?.toLocaleString('fr') ?? 0} Fbu</h4>
                                </div>
                                <div className="d-flex mt-2" style={{ fontSize: 14 }}>
                                    <div className="cursor-pointer z-2" onClick={(e) => { e.preventDefault(); e.stopPropagation(); setVisiblefournisseursProduits(true); }}>
                                        Capital : {CapitalTotCreditRembourse ?? 0}
                                    </div>
                                    <span className="mx-1">|</span>
                                    <div className="cursor-pointer z-2" onClick={(e) => { e.preventDefault(); e.stopPropagation(); setVisiblefournisseursservice(true); }}>
                                        Intérêt : {interetTotalCreditRembourse ?? 0}
                                    </div>
                                </div>
                            </div>
                        </div>

                        {/* Bloc Capital restant dû */}
                        <div className="cursor-pointer rounded border dashboad-main_counter"
                            style={{
                                height: 150,
                                width: "24%",
                                background: "linear-gradient(to bottom, #0641FF, #0F18C7)",
                            }}
                            onClick={(e) => {
                                e.preventDefault(); e.stopPropagation(); setRecetteNonPaye(true);
                            }}>
                            <div className="d-flex flex-column justify-content-center mt-3 px-2">
                                <h5 className="text-muted dashboard-title text-white">Capital Restant dû</h5>
                                <div className="d-flex align-items-center mt-1">
                                    {/* <img src="/images/nodebu.jpg"  style={{ width: 50, height: 30 }} /> */}
                                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="40" viewBox="0 0 24 24"><path fill="white" d="M12 16q-.825 0-1.412-.587T10 14t.588-1.412T12 12t1.413.588T14 14t-.587 1.413T12 16M7.375 7h9.25l2-4H5.375zM8.4 21h7.2q2.25 0 3.825-1.562T21 15.6q0-.95-.325-1.85t-.925-1.625L17.15 9H6.85l-2.6 3.125q-.6.725-.925 1.625T3 15.6q0 2.275 1.563 3.838T8.4 21" /></svg>
                                    <h4 className="dashboard-title ml-2">{MontantToatalCapitalRestantDu?.toLocaleString('fr') ?? 0} Fbu</h4>
                                </div>
                                <div className="d-flex mt-2" style={{ fontSize: 14 }}>
                                    <div className="cursor-pointer z-2" onClick={(e) => { e.preventDefault(); e.stopPropagation(); setVisiblevinsvendusTotalbouteille(true); }}>
                                        Capital : {CapitalTotalRestantdu ?? 0}
                                    </div>
                                    <span className="mx-1">|</span>
                                    <div className="cursor-pointer z-2" onClick={(e) => { e.preventDefault(); e.stopPropagation(); setVisiblevinsvendusTotalcarton(true); }}>
                                        Intérêt : {InteretTotalCapitalRestantDu ?? 0}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="cursor-pointer rounded border dashboad-main_counter"
                            style={{
                                height: 150,
                                width: "24%",
                                background: "linear-gradient(to bottom, #CE3A04, #FF990A)",
                            }}>
                            <div className="d-flex flex-column justify-content-center mt-3 px-2">
                                <h5 className="text-muted dashboard-title text-white">Cotisations</h5>
                                <div className="d-flex align-items-center mt-1">
                                    ...
                                    {/* <img src="/images/nodebu.jpg"  style={{ width: 50, height: 30 }} /> */}
                                    <h4 className="dashboard-title ml-2">{CapitalTotalCotisationsMembres?.toLocaleString('fr') ?? 0} Fbu</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="cursor-pointer rounded border dashboad-main_counter"
                            style={{
                                height: 150,
                                width: "24%",
                                background: "linear-gradient(to bottom,rgb(18, 213, 220),rgb(22, 148, 157))",
                            }}>
                            <div className="d-flex flex-column justify-content-center mt-3 px-2">
                                <h5 className="text-muted dashboard-title text-white">Pénalités</h5>
                                <div className="d-flex align-items-center mt-1">
                                    ...
                                    {/* <img src="/images/nodebu.jpg"  style={{ width: 50, height: 30 }} /> */}
                                    <h4 className="dashboard-title ml-2">{Pénalités?.toLocaleString('fr') ?? 0} Fbu</h4>
                                </div>
                            </div>
                        </div>

                        {/* Bloc Frais d'adhésion */}
                        <div className="cursor-pointer rounded border dashboad-main_counter"
                            style={{
                                height: 150,
                                width: "24%",
                                background: "linear-gradient(to bottom, #CA4B6A, #AC262F)",
                            }}>
                            <div className="d-flex flex-column justify-content-center mt-3 px-2">
                                <h5 className="text-muted dashboard-title text-white">Frais d’adhésion</h5>
                                <div className="d-flex align-items-center mt-1">
                                    ...
                                    {/* <img src="/images/nodebu.jpg" style={{ width: 50, height: 30 }} /> */}
                                    <h4 className="dashboard-title ml-2">{CapitalTotalFraisAdhions?.toLocaleString('fr') ?? 0} Fbu</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="cursor-pointer rounded border dashboad-main_counter"
                            style={{
                                height: 150,
                                width: "24%",
                                background: "linear-gradient(to bottom, #BC6B6A, #CC262F)",
                            }}>
                            <div className="d-flex flex-column justify-content-center mt-3 px-2">
                                <h5 className="text-muted dashboard-title text-white">Commission</h5>
                                <div className="d-flex align-items-center mt-1">
                                    {/* <img src="/images/nodebu.jpg" style={{ width: 50, height: 30 }} /> */}
                                    ...
                                    <h4 className="dashboard-title ml-2">{CapitalTotalCommissionRemboursement?.toLocaleString('fr') ?? 0} Fbu</h4>
                                </div>
                            </div>
                        </div>
                    ...
                    {/* dashboardPerformenceCreditRembImp */}
                    ...
                    <DashboardCotisationsDixDerniersActivites
                        dates={dates}
                        loading={loading}
