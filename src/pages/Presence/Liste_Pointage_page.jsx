...
export default function Liste_Pointage_page() {
    ...
    const deleteItems = async (itemsIds) => {
        try {
            ...
            dispacth(
                setToastAction({
                    severity: "success",
                    summary: " Liste supprimé",
                    detail: "Liste Pointage a été supprimé avec succès",
                    life: 3000,
                })
            );
            fetchEmploye();
    ...
    const fetchEmploye = useCallback(async () => {
        try {
            setLoading(true);
            const baseurl = `/presence/Pointages/fetch?`;
            var url = baseurl;
    ...
    useEffect(() => {
        ...
        dispacth(setBreadCrumbItemsAction([administration_routes_items.Pointages]));
        return () => {
        ...
        <>
            ...
            <div className="px-4 py-3 main_content">
                <div className="d-flex align-items-center justify-content-between">
                    <h1 className="mb-3">Pointages</h1>
                    <Button
                        label="Nouveau"
                        icon="pi pi-plus"
                        size="small"
