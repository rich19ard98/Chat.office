...
export default function Liste_notification_log_page() {
    ...
    const [type_notification, setType_notification] = useState([
        {
            code: 1,
            name: 'retard'
        },
    ...
    const fetchEmploye = useCallback(async () => {
        try {
            setLoading(true);
            const baseurl = `/presence/notification/fetch?`;
            var url = baseurl;
    ...
    useEffect(() => {
        ...
        dispacth(setBreadCrumbItemsAction([administration_routes_items.Planning]));
        return () => {
                                    ...
                                    return (
                                        <>
                                            ...
                                            <Link
                                                ...
                                                style={{ color: '#399af2' }}
                                                to={`/utilisateurs/${encodeId(item?.utilisateur?.UTILISATEUR_ID)}`}
                                                onClick={(e) => {
                                                    e.stopPropagation();
                                                }}
                      ...
                      <Column
                            ...
                            />
                               <Column
                                ...
                                sortable
                                body={(item) => {
                                    const type = type_notification.find(t => t.code === item.TYPE_NOTIFICATION);
