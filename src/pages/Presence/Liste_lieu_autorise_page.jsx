...
export default function Liste_lieu_autorise_page() {
    ...
    const fetchEmploye = useCallback(async () => {
        try {
            setLoading(true);
            const baseurl = `/presence/lieu_autorise/fetch?`;
            var url = baseurl;
    ...
    useEffect(() => {
        document.title = "Lieu_autorise"
        dispacth(setBreadCrumbItemsAction([administration_routes_items.Lieu_autorise]));
        return () => {
        ...
        <>
            ...
            <div className="px-4 py-3 main_content">
                <div className="d-flex align-items-center justify-content-between">
                    <h1 className="mb-3">Lieu Autorise</h1>
                    <Button
                        label="Nouveau"
                        icon="pi pi-plus"
                        size="small"
                        onClick={() => {
                            navigate("/Lieu_Autorise/new");
                        }}
                    />
                </div>
                ...
                <div className="shadow my-2 bg-white p-3 rounded d-flex align-items-center justify-content-between">
                    ...
                    {presencePermission && presencePermission.CAN_WRITE ?
                    ...
                    <div className="shadow rounded mt-3 pr-1 bg-white">
                        ...
                        >
                            ...
                            <Column
                                ...
                                header="Latitude"
                                sortable
                                body={(item) => item.LATITUDE}
                            />
                               <Column
                                field="LONGITUDE"
                                header="Longitude"
                                sortable
                                body={(item) => item.LONGITUDE}
                            />

                            <Column
                                field="RAYON_AUTORISE_METRES"
                                header="Rayon autorise"
                                sortable
                                body={(item) => item.RAYON_AUTORISE_METRES}
                            />
