...
export default function Statuts_credit_liste_page() {
  ...
  const fetchStatutcredit = useCallback(async () => {
    try {
      setLoading(true);
      const baseurl = `/parametre/statutscredit/fetchstatutcredit?`;
      var url = baseurl;
      ...
      setStatutscredit(res.result.data);
    ...
    <>
      ...
      <div className="px-4 py-3 main_content">
        <div className="d-flex align-items-center justify-content-between">
          <h1 className="mb-3">Statut crédit</h1>
                    ...
                    const items = [

                      {
                        template: (deleteItem, options) => {
                          return (
                            <Link
                              to={`/statutscredit/edit/${inViewMenuItem?.ID_STATUTS_CREDIT}`}
