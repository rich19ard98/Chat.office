...
export default function Compte_comptables_membres_listes() {
        ...
        <>
            ...
            <div className="px-4 py-3 main_content">
                {pdfUrl ? (
                    <>
                        <div className="mt-4">
                            <h1 className="mb-3">Listes Des Comptes membres :</h1>
                            <iframe
                                src={pdfUrl}
                                width="100%"
                                height="800px"
                    ...
                    <>
                        <div className="d-flex align-items-center justify-content-between">
                            <h1 className="mb-3">Comptes membres</h1>
                            ...
                            <div className="flex bg-white align-items-center ml-5 justify-content-end gap-5">
                                ...
                                <div
                                    ...
                                    style={{
                                        ...
                                        opacity: Comptes.length === 0 ? 0.6 : 1,
                                    }}
                                >
                                    {/* Ton SVG ici */}
                                    PDF
                            ...
                            <div className="shadow rounded mt-3 pr-1 bg-white" style={{ paddingBottom: '4rem' }}>
                                ...
                                .round-indicator .p-image-preview-indicator {
                                                ...
                                                <>
                                                    ...
                                                    {item?.membre ?
                                                        <Link
                                                            ...
                                                            style={{ color: '#399af2' }}
                                                            to={`/utilisateurs/${encodeId(item?.MEMBRE_ID)}`}
                                                            onClick={(e) => {
                                                                e.stopPropagation();
                                                            }}
                                    ...
                                    <Column
                                        ...
                                        body={(item) => {
                                            return (
                                                <span>{item.SOLDE ? parseFloat(item.SOLDE).toLocaleString('fr-FR') : 0} Fbu</span>
                                            );
                                        }}
                                    />
                                    <Column
                                    ...
                                    <Column
                                        ...
                                        sortable
                                        body={(item) => {
                                            return moment(item.DATE_CREATION).format("DD/MM/YYYY");
