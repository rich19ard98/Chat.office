...
export default function Types_de_fonction_add_page() {
    ...
    const handleSubmit = async (e) => {
        try {
            ...
            if (isValidate()) {
                ...
                const res = await fetchApi(`/gerers/types_de_fonction/create`, {
                ...
                dispacth(
                    setToastAction({
                        severity: "success",
                        summary: "Fonction enregistré",
                        detail: " fonction a été enregistré avec succès",
                        life: 3000,
                    })
                );
    ...
    useEffect(() => {
        dispacth(
            setBreadCrumbItemsAction([
                ...
                administration_routes_items.new_types_de_fonction,
            ])
        );
        return () => {
    ...
    return (
        <>
            ...
            <div className="px-4 py-3 main_content bg-white has_footer">
                <div className="">
                    <h1 className="mb-3">Nouveau  fonction</h1>
                    <hr className="w-100" /> 
                </div>
