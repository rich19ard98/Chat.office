...
export default function ListesAgences() {
    ...
    const FetchListeAlimentation = useCallback(async (silent = false, forceRefresh = false) => {
        try {
            ...
            const baseurl = `/Caisses/Alimentation/fetch?`;
        ...
        <>
            ...
            <div className="px-4 py-3 main_content">
                <div className="d-flex align-items-center justify-content-between">
                    <h1 className="mb-3">Listes des Alimentations</h1>
                        ...
                        >
                                            ...
                                            {item?.utilisateur_operation ?
                                                ...
                                                >
                                                    ...
                                                    <div className="d-flex round-indicator">
                                                        ...
                                                        {item?.utilisateur_operation.IMAGE ? (
                                                            <Image
                                                                src={item?.utilisateur_operation?.IMAGE}
                                                                alt="Image"
                                                                className="rounded-5"
                                                            ...
                                                            <div style={{
                                                                ...
                                                                {item?.utilisateur_operation?.NOM.charAt(0)}{item?.utilisateur_operation?.PRENOM.charAt(0)}
                                                            </div>
                                                        )}
                                                        <div className="ml-2 mt-1">
                                                            <div className="font-bold">
                                                                {item?.responsable?.NOM} {item?.utilisateur_operation?.PRENOM}
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            {item?.utilisateur_validation ?
                                                ...
                                                >
                                                    ...
                                                    <div className="d-flex round-indicator">
                                                        ...
                                                        {item?.utilisateur_validation.IMAGE ? (
                                                            <Image
                                                                src={item?.utilisateur_validation?.IMAGE}
                                                                alt="Image"
                                                                className="rounded-5"
                                                                imageClassName="rounded-5 object-fit-cover"
                                                                imageStyle={{ width: "30px", height: "30px" }}
                                                            ...
                                                            <div style={{
                                                                ...
                                                                {item?.utilisateur_validation?.NOM.charAt(0)}{item?.utilisateur_validation?.PRENOM.charAt(0)}
                                                            </div>
                                                        )}
                                                        <div className="ml-2 mt-1">
                                                            <div className="font-bold">
                                                                {item?.utilisateur_validation?.NOM} {item?.utilisateur_validation?.PRENOM}
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            border-radius: 50%
                                    ...
                                    return (
                                        ...
                                        <>
                                            ...
                                            <Link
                                                id={`Nocmnde-${item.ID_ALIMENTATION}`}
                                                className="text-decoration-none d-flex round-indicator"
                                                style={{ color: '#399af2' }}
                                                to={`/Alimentation/valide/${encodeId(item?.ID_ALIMENTATION)}`}
                                                onClick={(e) => {
                                                    const Id = item.ID_ALIMENTATION
                            ...
                            <Column
                                ...
                                body={(item) => {
                                    return (
                                        <span>
                                            {item?.source_caisse?.NOM_CAISSE} <br />
                                            {item?.source_caisse?.NUMERO_COMPTE}
                                        </span>
                            ...
                            <Column
                                ...
                                body={(item) => {
                                    return (
                                        <span>
                                            {item?.destination_caisse?.NOM_CAISSE} <br />
                                            {item?.destination_caisse?.NUMERO_COMPTE}
                                        </span>
                                    );
                                }}
                            />
                            ...
                            <Column
                                ...
                                body={(item) => {
                                    ...
                                    const { backgroundColor, textColor, icon } = statutalimentationColor(statut);
                                    let tooltipText = '';

                                    if (statut === 0) tooltipText = 'Validé';
                                    else if (statut === 1) tooltipText = 'En attente';
                                    else if (statut === 2) tooltipText = 'Rejeté';
                                    else tooltipText = '-';
                                    ...
                                    return (
                                        <Button
                                            ...
                                            icon={() => <span className="mb-1" dangerouslySetInnerHTML={{ __html: icon }} />}
                                        />
                                    );
                                }}
                            />
                            ...
                            <Column
                                ...
                                body={(item) => {
                                    ...
                                    const items = [
                                        ...
                                        //         return (
                                        //             <Link
                                        //                 to={`/Alimentation/update/${encodeId(inViewMenuItem?.ID_AGENCE)}`}
                                            ...
                                            template: (deleteItem, options) => {
                                                return (
                                                    <a
                                                        ...
                                                        onClick={(e) =>
                                                            handleAnnulerAlimentation(e, [
                                                                inViewMenuItem.ID_ALIMENTATION,
                                                            ])
                                                        }
                                                    >
                                                        <svg
