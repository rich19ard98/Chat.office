...
export default function ModifierGroupementsFinanciere() {
    const dispacth = useDispatch();
    const [data, handleChange, setData, setValue] = useForm(initialForm);
    const [membre, setMembres] = useState([])
    const { ID_GROUPEMENT: encodedStr } = useParams();
    const ID_GROUPEMENT = decodeId(encodedStr)
    ...
    const handleSubmit = async (e) => {
        try {
            ...
            if (isValidate()) {
                ...
                const res = await fetchApi(`/Caisses/Groupement/update/${ID_GROUPEMENT}`, {
                    method: "POST",
                    body: form,
                });
    ...
    const FetchGroupements = useCallback(async () => {
        try {
            setLoading(true);
            const baseurl = `/Caisses/Groupement/Find/${ID_GROUPEMENT}?`;
            ...
            setData({
                NOM_GROUPEMENT: resultats?.NOM_GROUPEMENT,
                ADRESSE:resultats.ADRESSE,
                TELEPHONE:resultats.TELEPHONE
    ...
    return (
        <>
            ...
            <div className="px-4 py-3 main_content bg-white has_footer">
                <div className="">
                    <h1 className="mb-3">Modifier Groupement</h1>
