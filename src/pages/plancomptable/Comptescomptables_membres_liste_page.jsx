 ...
 * @author trenik <trenik@gmail.com>
 */
export default function Comptescomptables_membres_liste_page() {
    ...
    const fetchComptesComptables = useCallback(async () => {
        try {
            setLoading(true);
            let url = `/plancomptable/comptescomptables/fetchCompteMembre?`;
        ...
        <>
            ...
            <div className="px-4 py-3 main_content">
                <div className="d-flex align-items-center justify-content-between">
                    <h1 className="mb-3">Comptes comptables membres</h1>
                    {/* <Button
                    ...
                    <div className="shadow rounded mt-3 bg-white">
                        <DataTable
                            ...
                            onSelectionChange={(e) => {
                                ...
                                setSelectAll(e.value.length === totalRecords);
                            }}
                            selectAll={selectAll}
                            onSelectAllChange={(e) => {
                                setSelectAll(e.checked);
                                setSelectedItems(e.checked ? comptesComptables : []);
                            }}
                            rowsPerPageOptions={[5, 10, 25, 50]}
                            currentPageReportTemplate={` {first} - {last} sur ${totalRecords} éléments`}
                        ...
                        >
                            ...
                            <Column
                                field="NOM"
                                header="Nom du Titulaire"
                                sortable
                                body={(item) => <span>{`${item.membre.NOM} ${item.membre.PRENOM}`}</span>}
                            />
                            <Column
                                field="TYPE"
                                header="Type"
