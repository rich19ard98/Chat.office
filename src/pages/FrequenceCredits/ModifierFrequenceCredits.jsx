...
export default function AjouterFrequenceCredits() {
    ...
    const { ID_FREQUENCE_CREDIT: encodedStr } = useParams();
    const ID_FREQUENCE_CREDIT = decodeId(encodedStr)
    ...
    const handleSubmit = async (e) => {
        try {
            ...
            if (isValidate()) {
                ...
                const res = await fetchApi(`/FrequenceCredits/Frequencecredits/update/${ID_FREQUENCE_CREDIT}`, {
                    method: "POST",
                    body: form,
                });
    ...
    const FetchFrequenceCredits = useCallback(async () => {
        try {
            setLoading(true);
            const baseurl = `/FrequenceCredits/Frequencecredits/Find/${ID_FREQUENCE_CREDIT}?`;
            ...
            setmodes(Resultats);
            setData({
                NOMBRE_JOURS: Resultats?.NOMBRE_JOURS,
                NON_FREQUENCE_CREDIT: Resultats?.NON_FREQUENCE_CREDIT,
    ...
    return (
        <>
            ...
            <div className="px-4 py-3 main_content bg-white has_footer">
                <div className="">
                    <h1 className="mb-3">Modifier Frequence Credits</h1>
