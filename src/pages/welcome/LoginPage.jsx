...
export default function LoginPage() {
    ...
    //         // if (user?.ID_PROFIL === 2) {
    //         //     // Redirige vers l’espace membre
    //         //     navigate("/credits")
    //         // } else {
    //         //     // Redirige vers la page d’accueil ou admin
    //         //     navigate("/")
    //         // }
    //         if (user?.ID_PROFIL === 2 && user?.ID_UTILISATEUR) {
    //             // Encode l'ID si nécessaire
    //             const encodedId = btoa(user.ID_UTILISATEUR.toString()) // base64
    //             navigate(`/membre_microfinance/Details?ID=${encodedId}`)
    //         } else {
    //             navigate("/")
    //         }
    ...
    //             dispatch(setToastAction({ severity: 'error', summary: 'Identifiants incorrect', detail: "Vérifier votre email ou mot de passe", life: 3000 }));
    //         } else {
