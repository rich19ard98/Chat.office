...
export default function ModifierAgences() {
    ...
    const { ID_AGENCE: encodedStr } = useParams();
    const ID_AGENCE = decodeId(encodedStr)
    ...
    const handleSubmit = async (e) => {
        try {
            ...
            if (isValidate()) {
                ...
                const res = await fetchApi(`/Agences/Agences/update/${ID_AGENCE}`, {
                    method: "POST",
                    body: form,
                });
    ...
    const FetchAgences = useCallback(async () => {
        try {
            setLoading(true);
            const baseurl = `/Agences/Agences/Find/${ID_AGENCE}`;
...
console.log({res});
            ...
            setData({
                NOM_AGENCE: resultats?.NOM_AGENCE,
                TELEPHONE: resultats?.TELEPHONE,
                ADRESSE: resultats?.ADRESSE,
                ID_GROUPEMENT: {
                    name: `${resultats.groupement.NOM_GROUPEMENT}`,
                    code: resultats.groupement.ID_GROUPEMENT
                }
            })
    ...
    return (
        <>
            ...
            <div className="px-4 py-3 main_content bg-white has_footer">
                <div className="">
                    <h1 className="mb-3">Modifier Agence</h1>
