...
export default function AjouterCaissier() {
    ...
    const { ID_CAISSIER: encodedStr } = useParams();
    const ID_CAISSIER = decodeId(encodedStr)
    ...
    const handleSubmit = async (e) => {
        try {
            ...
            if (isValidate()) {
                ...
                const res = await fetchApi(`/Caisses/Caissier/update/${ID_CAISSIER}`, {
                    method: "POST",
                    body: form,
                });
    ...
    const FetchCaissier = useCallback(async () => {
        try {
            const baseurl = `/Caisses/Caissier/Find/${ID_CAISSIER}?`;
            ...
            setData({
                ...
                SOLDE_INITIAL: Resultats.SOLDE_INITIAL,
                ID_UTILISATEUR: {
                    name: `${Resultats.utilisateur.NOM} ${Resultats.utilisateur.PRENOM}`,
                    code: Resultats.utilisateur.ID_UTILISATEUR
                },
                ID_AGENCE: {
    ...
    return (
        <>
            ...
            <div className="px-4 py-3 main_content bg-white has_footer">
                <div>
                    <h1 className="mb-3">Modifier Caissier</h1>
                    <hr className="w-100" />
                </div>
