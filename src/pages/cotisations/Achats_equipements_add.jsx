...
export default function Achats_equipements_add() {
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      if (isValidate()) {
        ...
        const res = await fetchApi(`/cotisation/Achats_equipements/create`, {
          method: "POST",
          body: form,
        });
          ...
          window.scrollTo({
            ...
            behavior: "smooth",
              ...
              dispacth(
                setToastAction({
                  severity: "warn",
                  summary: "Erreur lors de cotisation des equipements",
  ...
  useEffect(() => {
    dispacth(
      setBreadCrumbItemsAction([
        administration_routes_items.AchatsEquipements,
        administration_routes_items.AchatsEquipements_add,
      ])
    );
    return () => {
...
console.log(res);
      ...
      const filteredOperations = res.result.data.filter((clM) =>
        clM.NOM_OPERATION === "Achat equipement" 
