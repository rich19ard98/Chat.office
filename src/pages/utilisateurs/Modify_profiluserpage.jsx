      ...
      if (isValidate()) {
        ...
        if (connectedUser) {
          const newUser = {
           ...
           dispacth(setUserAction(newUser));

           // Afficher le message de succès
           dispacth(setToastAction({
             severity: "success",
             summary: "Profil modifié",
             detail: "Votre profile vous a été modifié avec succès",
             life: 3000,
           }));
    ...
    dispacth(setBreadCrumbItemsAction(
      user.ID_PROFIL === PROFILS.ADMIN
        ? [
            ...
            { path: 'edit_utilisateur', name: "Modifier le profil" }
          ]
        : [
            { path: 'edit_utilisateur', name: "Modifier le profil" }
          ]
    ...
    <>
      ...
      <div className="px-4 py-3 main_content bg-white has_footer">
        ...
        >
          ...
          {/* NOM & PRÉNOM bien centrés sous l’image */}
