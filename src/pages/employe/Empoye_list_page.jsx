...
export default function Empoye_list_page() {
    ...
    const fetchEmploye = useCallback(async () => {
        try {
            setLoading(true);
            let url = `/gerers/employe/fetch??rows=100000&`;
    ...
    useEffect(() => {
        document.title = "Liste des employées"
        ...
        <>
            ...
            <div className="px-4 py-3 main_content">
                <div className="d-flex align-items-center justify-content-between">
                    <h1 className="mb-3">Employées</h1>
                    ...
                    <div className="shadow rounded mt-3 pr-1 bg-white">
                        ...
                        >
                            ...
                            <Column
                                ...
                                header="Fonction"
                                sortable
                                body={item => item?.types_de_fonction?.LIBELLE || '-'}
                            />
