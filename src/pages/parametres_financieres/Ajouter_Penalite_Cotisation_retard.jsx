...
export default function Ajouter_Penalite_Cotisation_retard() {
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      if (isValidate()) {
        ...
        const res = await fetchApi(`/parametre/cotisationretard/create`, {
          method: "post",
          body: form,
        });
        dispacth(
  ...
  return (
    <>
      ...
      <div className="px-4 py-3 main_content bg-white has_footer">
        <div className="">
          <h1 className="mb-3">Nouveau Taux de penalite</h1>
