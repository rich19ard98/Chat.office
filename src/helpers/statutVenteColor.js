...
export default function statutVenteColor(idStatut) {
  const defaultColor = {
  ...
  const COLORS = {
    ...
    [STATUT_VENTE.PARTIELLEMENT_PAYE]: {
  ...
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
    ...
    [STATUT_VENTE.EN_BROUILLON]: {
      backgroundColor: '#7986CB',
      textColor: '#f5f5f5',
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-ban" viewBox="0 0 16 16">
      <path d="M15 8a6.97 6.97 0 0 0-1.71-4.584l-9.874 9.875A7 7 0 0 0 15 8M2.71 12.584l9.874-9.875a7 7 0 0 0-9.874 9.874ZM16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0"/>
    </svg>`
    },

    [STATUT_VENTE.EN_ATTENTE_DE_PAIEMENT]: {
    ...
    [STATUT_VENTE.REMBOURSEMENT]: {
      backgroundColor: '#DD9C20',
      textColor: '#f5f5f5',
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-bar-right" viewBox="0 0 16 16">
